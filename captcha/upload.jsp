...
<p>Y: <span id="y2"></span></p><br>
    ...
    <form  action="upload"name="form1" method="post" enctype="multipart/form-data">
            <p><strong>First Point:</strong></p><br>
                <p>X: <input type="text" id="x1" name="xx1" readonly></input></p><br>
                    <p>Y: <input type="text" id="y1" name="yy1" readonly></input></p><br>
<p><strong>Second Point:</strong></p><br>
    <p>X: <input type="text" id="x2" name="xx2" readonly></input></p><br>
        <p>Y: <input type="text" id="y2"  name="yy2" readonly></input></p><br>
